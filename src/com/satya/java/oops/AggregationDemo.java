...
public class AggregationDemo {
	...
	public static void main(String[] args) {
		...
		Emloyee e = new Emloyee(1, "satyajit", add);
...
class Emloyee {
	...
	public Emloyee(int id, String name, Address address) {
		super();
		this.id = id;
		this.name = name;
	...
	public String toString() {
		return id + " " + name + " " + address.getCity() + " " + address.getState() + " " + address.getDistrict() + " "
				+ address.getPin();
	}
}
